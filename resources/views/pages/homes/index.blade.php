        ...
        <div class="row">
          ...
          <div class="col-xl-6 col-lg-5 pt-5 pt-lg-0">
            ...
            <div class="icon-box" data-aos="fade-up">
              ...
              <h4>Orientation</h4>
              <p>Un système d'Orientation vous permettant de faire le meilleur choix</p>
            </div>

            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              <i class="bx bx-cube-alt"></i>
              <h4>Formation</h4>
              <p>Nous vous aiderons dans le choix des formations necessaire pour votre reussite</p>
            </div>

            <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
              <i class="bx bx-cube-alt"></i>
              <h4>Forum</h4>
              <p>Un système de forum vas vous pemettre d'etre en contact avec les etudiant en vu d'expose vos preocupation</p>
            </div>
